' access cnn material pop verser pubished will platform of extension freebasic
' CNAPIM information to study fiscal to machines states electoral to report micro
' action provides pec enlarging journal guides cnn freebasic and etc langauges.
' aprove fonts of process.
Declare Function AccessMaterialCnn ( ByRef Learn As T1, ByRef Tutorial As T2, ByRef Guides As T3)

Type Learn
    Dim LearnTypes As T1
End Type

Type Tutorial
    Dim TutorialEvent As T2
End Type 

Type Guides
    Dim GuidesObjes As T3
End Type 


If Learn *= "LearnType" Then
   Print "CNAPIM Learn type pop published will"
   Dim n As Double
   n = 6
   n *= 2
Print n
...
If Tutorial *= "Tutorial" Then
   Print "CNAPIM Tutorial type pop published will"
   Dim n As Double
   n = 6
   n *= 2
Print n
...
If Guides *= "Guides" Then
   Print "CNAPIM Guides type pop published will"
   Dim n As Double
   n = 6
   n *= 2
Print n
...
#define CNAPIM1 False: 972 mill/sec
#define CNAPIM2 True:  973 mill/sec 972 mill/sec
