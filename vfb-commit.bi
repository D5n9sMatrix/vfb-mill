' block max relation reduce values 6 million to manifest
' capital hot money public sublime verb block quotes
' reposability parlament about respect the all humanity
' constituied concrets.
Declare Function BlockMax (ByRef Reduce As T1, ByVal Money As T2, ByVal Values As T3)

Type Reduce
     Dim ReduceTypes As T1
End Type 

Type Money
     Dim MoneyEvent As T2
End Type 

Type Values
     Dim ValuesObjes As T3 
End Type 

#define Reduce1 False: 310 mill/sec
#define Money2  True:  268 mill/sec 270 mill/sec
#define Value1  False: 972 mill/sec
#define Value2  True:  973 mill/sec 972 mill/sec
