' position of the best to more electory
' small govern to senator gov aprove the
' pec to postulant about postulation
' policy ...
Declare Function TheBest ( ByRef Electory As T1, ByRef Govern As T2, ByRef Policy As T3)

Type Electory
     Dim ElectoryTypes As T1
End Type

Type Govern
     Dim GovernEvent As T2
End Type 

Type Policy
     Dim PolicyObjes As T3 
End Type

If Electory += "Electory" Then 
   Print "NuGet Position The Best"
   Dim NuGet As Double
NuGetDog = 1234567890
NuGetDog += 1000
Print NuGet
...
If Govern += "Govern" Then
   Print "Nuget Senator gov aprove"
   Dim NuGet As Double
NuGetCat = 1234567890
NuGetCat += 1000
Print NuGet
...
If Policy += "Policy" Then
   Print "NuGet Deput gov successful"
NuGetHorse = 1234567890
NuGetHorse += 1000
Print NuGet
Sleep 
